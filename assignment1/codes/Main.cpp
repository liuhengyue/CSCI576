...
//subsampling parameters,no larger than image width, 1 for no subsampling
int y, u, v;
//quantization parameter values. eg: 256
int q;
                     ...
                     int       nCmdShow)
{
	...
	sscanf(lpCmdLine, "%s %d %d %d %d" , &ImagePath, &y, &u,&v,&q);
	inImage.setWidth(w);
	inImage.setHeight(h);
